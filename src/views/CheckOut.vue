    ...
    <section class="py-20 bg-gray-100">
      <div class="container mx-auto px-4">
        <div class="p-8 lg:p-20 bg-white">
          <h2 class="mb-20 text-5xl font-bold font-heading">Billing address</h2>
          <div class="flex flex-wrap -mx-4">
              ...
              <form action="submitform">
                <div class="flex flex-wrap -mx-4">
                  <div class="w-full lg:w-1/2 px-4 mb-10 lg:mb-0">
                    <div class="mb-10">
                      <label class="font-bold font-heading text-gray-600" for=""
                        >First Name *</label
                      >
                      <input
                        v-model="firstname"
                        class="block w-full mt-4 py-4 px-4 border border-gray-200 focus:ring-blue-300 focus:border-blue-300 rounded-md required"
                        required
                        type="text" />
                    </div>
                  </div>
                  ...
                  <div class="w-full mb-8 px-4">
                    <h3 class="mb-4 font-bold font-heading text-gray-600">
                      Payment
                    </h3>
                    <label class="flex mb-6 items-center">
                      <input
                    ...
                    <div class="flex flex-wrap -mx-4 mb-10">
                      <div class="w-full lg:w-1/2 px-4 mb-10 lg:mb-0">
                        <div>
                          ...
                          >
                          <input
                            class="block w-full mt-4 mb-4 py-4 px-4 border border-gray-200 focus:ring-blue-300 focus:border-blue-300 rounded-md"
                            type="text" />
            ...
            <div v-if="product" class="w-full xl:w-1/3 px-4">
              <div class="mb-12 p-6 lg:p-12 bg-blue-500 rounded-md">
              ...
              <div>
                ...
                <div class="flex mb-12 flex-wrap lg:flex-nowrap items-center">
                  <input
                    class="inline-block mb-4 md:mb-0 mr-4 px-4 py-4 placeholder-gray-800 font-bold font-heading border border-gray-200 focus:ring-blue-300 focus:border-blue-300 rounded-md"
                    type="text"
                    placeholder="SUMMER30X" />
                  <a
                    class="inline-block mb-4 md:mb-0 px-7 py-4 text-white font-bold font-heading uppercase bg-gray-800 hover:bg-gray-700 rounded-md"
                    >Apply</a
                  >
                </div>
                <router-link
            ...
            <div v-else>
              <h1 class="uppercase text-4xl text-red-500 font-semibold">
                whoops something went wrong
              </h1>

              <router-link to="/"
                ><button class="py-2 px-6 bg-yellow-500 mt-5 rounded-xl">
                  <a href="#"></a>Go back home page
                </button>
              </router-link>
            </div>
          </div>
