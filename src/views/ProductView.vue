  ...
  <div v-if="product" class="container mx-auto px-4">
        ...
        <div class="flex flex-wrap -mx-2">
          <div class="w-1/2 sm:w-1/4 p-2">
            <a class="block border border-blue-300" href="#">
              <img class="w-full h-32 object-cover" :src="product.image" alt="">
            </a>
          </div>
          <div class="w-1/2 sm:w-1/4 p-2">
      ...
      <div class="w-full md:w-1/2 px-4">
        <div class="lg:pl-20">
          <div class="mb-10 pb-10 border-b">
            ...
            <div class="mb-8">
              <button>
                <img src="../assets/image/icons8-star.svg" alt="">
              </button>
              <button>
                <img src="../assets/image/icons8-star.svg" alt="">
              </button>
              ...
              <button>
                <img src="../assets/image/icons8-star-gray.svg" alt="">
              </button>
            </div>
            <p class="inline-block mb-8 text-2xl font-bold font-heading text-blue-600">
              <span>$29.99</span>
              <span class="font-normal text-base ml-4 text-gray-400 line-through">{{product.price}}</span>
            </p>
          ...
          <div class="flex flex-wrap -mx-4 mb-14 items-center">
              ...
              <div class="w-full xl:w-2/3 px-4 mb-4 xl:mb-0 curser-">
                <a class="block bg-orange-500 hover:bg-orange-400 text-center text-white font-bold font-heading py-5 px-8 rounded-md uppercase transition duration-200 " >Buy Now</a>
               </div>
          ...
          <div class="flex items-center">
            ...
            <a class="mr-1 w-8 h-8" href="#">
              <img src="../assets/image/icons8-instagram-50.svg" alt="">
            </a>
            <a class="mr-1 w-8 h-8" href="#">
              <img src="../assets/image/icons8-facebook-messenger-50.svg" alt="">
            </a>
            <a class="w-8 h-8" href="#">
              <img src="../assets/image/icons8-twitter-50.svg" alt="">
            </a>
          </div>
        </div>
      </div>
    ...
    <div>
      <ul class="flex flex-wrap mb-16 border-b-2">
        <li class="w-1/2 md:w-auto"><a class="inline-block py-6 px-10 bg-white text-gray-500 font-bold font-heading hover:shadow-xl" href="#">Description</a></li>
        <li class="w-1/2 md:w-auto"><a class="inline-block py-6 px-10 text-gray-500 font-bold font-heading hover:shadow-xl" href="#">Customer reviews</a></li>
        <li class="w-1/2 md:w-auto"><a class="inline-block py-6 px-10 text-gray-500 font-bold font-heading hover:shadow-xl" href="#">Shipping &amp; returns</a></li>
        <li class="w-1/2 md:w-auto"><a class="inline-block py-6 px-10 text-gray-500 font-bold font-heading hover:shadow-xl" href="#">Brand</a></li>
      </ul>
      <h3 class="mb-8 text-3xl font-bold font-heading text-blue-500">Summer collection and laoreet get</h3>
