      ...
      <div class="container px-4 mx-auto">
        <div class="max-w-5xl mx-auto">
          <div class="flex flex-wrap items-center -mx-10">
            <div class="w-full lg:w-1/2 px-10">
              <div
                ...
                <form @submit.prevent="handleSubmit">
                  ...
                  <div
                    class="flex items-center pl-6 mb-3 border border-gray-50 bg-white rounded-full">
                  ...
                  <!-- <div
                    class="flex items-center pl-6 mb-6 border border-gray-50 bg-white rounded-full">
                    <span class="inline-block pr-3 border-r border-gray-50">
                      <svg
                        class="w-5 h-5"
                        width="20"
                  ...
                  <div class="inline-flex mb-10">
                    ...
                    <p class="-mt-2 text-sm text-gray-500">
                      ...
                      <a class="text-gray-900" href="#">Terms, Data Policy</a
            ...
            <div
              class="w-full lg:w-1/2 px-10 mb-16 lg:mb-0 order-first lg:order-last">
              <div class="max-w-md">
                ...
                <p class="text-lg text-gray-500">
                  ...
                  <span class="font-bold">the lazy dog.</span>
                </p>
              </div>
            </div>
          </div>
